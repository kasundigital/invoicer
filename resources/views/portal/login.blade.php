<x-layouts.app>
    <div class="mx-auto max-w-md rounded-lg bg-white p-6 shadow">
        <h2 class="text-lg font-semibold">Customer Portal Login</h2>
        <p class="text-sm text-slate-500">Access your invoices and quotes.</p>

        <form class="mt-6 space-y-4" method="POST" action="{{ route('portal.login.submit') }}">
            @csrf
            <label class="block">
